/************************************************************************
	...
	FX3 Firmware main functions
        This work is a fork of the DomesdayDuplicator project who's original author
        is Simon Inss.
	Copyright (C) 2018 Simon Inns

        All subsequent modification has been done by Nassim Corteggiani.
...
// Application thread structure
CyU3PThread glAppThread;
// DMA multi-channel handle
CyU3PDmaMultiChannel glDmaMultiChHandle;
// Application active/ready flag
...
void CyFxThreadInitialise(uint32_t input)
{
  ...
  CyU3PDebugPrint(1, "DMon author:     (c)2020 Nassim CORTEGGIANI - https://www.dmon.com\r\n\r\n");
  CyU3PDebugPrint(1, "Original author: (c)2018 Simon Inns - https://www.domesday86.com\r\n\r\n");
