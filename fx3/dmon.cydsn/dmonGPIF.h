/*
 * Project Name: dmon.cyfx
 * Time : 11/09/2020 09:17:41
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_DOMESDAYDUPLICATORGPIF_
#define _INCLUDED_DOMESDAYDUPLICATORGPIF_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x2E701A01,0x00000800,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x3E739C02,0x00000100,0xC0000080},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739403,0x20000000,0x80000040},{0x00000000,0x00000000,0x00000000}},
    {{0x2E701A04,0x04000800,0xC0000000},{0x00000000,0x00000000,0x00000000}},
    {{0x3E739C05,0x00000100,0xC0000080},{0x00000000,0x00000000,0x00000000}},
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x00100004,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DIRECTION */
...
#endif   /* _INCLUDED_DOMESDAYDUPLICATORGPIF_ */
